...
import viamcp.common.gui.ExtendedServerData;
...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if (config.isShowAddServerButton()) {
            ...
            final ProtocolVersion target = ((ExtendedServerData) serverData).getVersion();
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        // ViaForgeMCP
        if (ViaMCPCommon.getManager().getConfig().isShowAddServerButton()) {
            if (button.id == 1_000_000_000) {
                mc.displayGuiScreen(new GuiProtocolSelector(this, true, (version, parent) -> {
                    ...
                    ((ExtendedServerData) serverData).setVersion(version);
